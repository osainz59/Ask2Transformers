...
parser.add_argument('-l', '--labels', type=str,
                    ...
                    help='Labels.')
parser.add_argument('--label_names', type=str,
                    default='data/babel_topics.txt',
                    help='Domain labels.')
...
def main(opt):
    ...
    with open(opt.output, 'wt') as f:
        ...
        for (sense_id, l, gloss), out, true in zip(info[wrong_predictions], output[wrong_predictions], labels[wrong_predictions]):
