...
def tacred2mnli(instance: REInputFeatures, positive_templates, negative_templates, templates, negn=1, posn=1):
...
def tacred2mnli_with_negative_pattern(
    instance: REInputFeatures, positive_templates, negative_templates, templates, negn=1, posn=1
):
    mnli_instances = []
    # Generate the positive examples
    positive_template = random.choices(positive_templates[instance.label], k=posn)
...
with open(args.input_file, 'rt') as f:
    ...
    for line in json.load(f):
        mnli_instance = tacred2mnli(REInputFeatures(
            ...
            label=line['relation']
        ), positive_templates, negative_templates, templates, negn=args.negn)
